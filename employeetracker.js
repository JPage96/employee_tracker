  ...
  inquirer
    .prompt([
      ...
      validate: function(answer) {
        ...
        return "Employee's last name must contain at least one character.";
        }
  ...
  inquirer
    ...
    .then(function(answer) {
      connection.query("INSERT INTO department SET ?",
        ...
        function(err) {
          if (err) throw err;
          console.log("This department has been successfully added!");
          run();
        }
      );
  });
  ...
  inquirer
    .prompt([
      ...
      validate: function(answer) {
        ...
        return "The role salay must contain at least one character.";
        }
      ...
      inquirer 
        ...
        .then(function(answer) {
          ...
          .then(function (roleAnswer) {
            ...
            console.log("Employee's role has been update!");
            run();
        })
